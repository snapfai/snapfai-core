import { TokensByChain } from './types';
...
import {
  getTokensForChainDefault,
  findTokenBySymbolDefault,
  findTokenByAddressDefault,
  getNativeTokenDefault,
  isTokenSupportedDefault,
  resolveTokenDefault,
  getDefaultTokenPairDefault,
} from './utils';

// Combine all chain tokens
...
// Re-export individual chain tokens for direct access if needed
export {
  ethereumTokens,
  bscTokens,
  arbitrumTokens,
...
// Backward compatibility exports (maintains the same API as the old tokens.ts)
// These functions work exactly like the old ones but use the new structure internally
export const getTokensForChain = getTokensForChainDefault;
export const findTokenBySymbol = findTokenBySymbolDefault;
export const findTokenByAddress = findTokenByAddressDefault;
export const getNativeToken = getNativeTokenDefault;
export const isTokenSupported = isTokenSupportedDefault;
export const resolveToken = resolveTokenDefault;
export const getDefaultTokenPair = getDefaultTokenPairDefault;
