        ...
        <div className="container">
          <div className="text-center">
            ...
            <div className="flex items-center justify-center gap-4 mb-4">
              <Link 
                href="http://x.com/snapFAI" 
                target="_blank" 
                rel="noopener noreferrer"
                className="text-gray-600 dark:text-gray-300 hover:text-snapfai-amber dark:hover:text-snapfai-amber transition-colors"
              >
              ...
              <Link 
                href="https://github.com/snapfai/snapfai-core" 
                target="_blank" 
                rel="noopener noreferrer"
                className="text-gray-600 dark:text-gray-300 hover:text-snapfai-amber dark:hover:text-snapfai-amber transition-colors"
              >
